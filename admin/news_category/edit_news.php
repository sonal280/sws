...
if (isset($_REQUEST['editid'])) {
  $select = "select * from news_category where cat_id = '".$_REQUEST['editid']."'";
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form method="post" enctype="multipart/form-data" name="myForm" id="myForm" action="news_category/edit_news_action.php">
                <div class="row">
                  <div class="form-group col-md-12">
                    <h5>Category Name<span class="text-danger"></span></h5>
                    <div class="controls">
                      <input type="text" name="cat_name" class="form-control hindi-input" data-validation-required-message="This field is required" value="<?php echo $row['cat_name']; ?>">
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <div class="controls">
                      ...
                      <img src="upload/news_category/<?php echo $row['cat_image']; ?>" alt="" style="height: 150px; width: 150px;">
                    </div>
                  </div>
                </div>
