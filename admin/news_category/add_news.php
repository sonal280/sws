...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="news/news.php">News Category</a></li>
     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form method="post" enctype="multipart/form-data" name="myForm" id="myForm" action="news_category/add_news_action.php">
                <div class="row">
                  <div class="form-group col-md-12">
                    <h5>Category Name<span class="text-danger">*</span></h5>
                    <div class="controls">
                      <input type="text" name="cat_name" class="form-control hindi-input" data-validation-required-message="This field is required">
                     </div>
                  </div>
                </div>
