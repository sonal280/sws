...
if (isset($_REQUEST['cat_id'])) {
	$query = "DELETE FROM news_category WHERE cat_id = '".$_REQUEST['cat_id']."'";
	$result = mysqli_query($con, $query);
	if ($result) {
		echo "<script>alert('News Category is deleted');</script>";
	}
}
 ?>
...
<div class="wrapper">
<a href="news_category/add_news.php" title="Add Category" id="return-to-top" class="btn btn-warning"><i class="fa fa-plus" ></i></a>
<?php include('../includes/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="news_category/add_news.php"><i class="fa fa-dashboard"></i> Home</a></li>
      ...
      <div class="box">
      	<div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive">
	        	...
	        	<tbody>
	            <?php 
	            	$select = "SELECT * FROM news_category order by cat_id desc";
				...
				<?php 
				 ...
				 ?>
	            		<tr>
	            			...
	            			<td><img src="../admin/upload/news_category/<?php echo $row['cat_image']; ?>" alt="" style ="height: 150px; width: 150px"></td>
	            			<td><?php echo $t2; ?></td>
	            			<td><a href="news_category/edit_news.php?editid=<?=$row['cat_id']?>" class="btn btn-warning">Edit</a> | <a href="news_category/news_category.php?cat_id=<?=$row['cat_id']?>" class="btn btn-danger" onclick = "return confirm('Are you sure want to delete')">Delete</a>
	            			</td>
	            		</tr>
	            <?php	
	            $i++;
