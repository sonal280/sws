...
$(function () {
  ...
  var $tabButton = $('<li />', { 'class': 'active nav-item' })
    .php('<a href=\'#control-sidebar-theme-demo-options-tab\' data-toggle=\'tab\'>'
  ...
  var $skinOrange =
        $('<li />', { style: 'float:left; width: 33.33333%; padding: 5px;' })
          .append('<a href="javascript:void(0)" data-skin="skin-orange" style="display: block; box-shadow: 0 0 3px rgba(0,0,0,0.4)" class="clearfix full-opacity-hover">'
