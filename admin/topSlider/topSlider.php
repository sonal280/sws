...
if (isset($_REQUEST['topSlider_id'])) {
	$delete = "DELETE FROM topslider WHERE id = '".$_REQUEST['topSlider_id']."'";
	$result = mysqli_query($con, $delete);
	if ($result) {
		echo "<script>alert('Your Slider is deleted');</script>";
		echo "<script>window.location('topSlider.php')</script>";
	}
...
<div class="wrapper">
<a href="topSlider/new_topSlider.php" title="Add Category" id="return-to-top" class="btn btn-warning"><i class="fa fa-plus" ></i></a>
      ...
      <div class="box">
      	<div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive">
	        	...
	        	<tbody>
	            <?php 
	            	$select = "SELECT * FROM topslider order by id desc";
				...
				<?php 
				 ...
				 ?>
	            		<tr>
	            			...
	            			<td><img src="upload/topSlider/<?php echo $row['image']; ?>" alt="" height="150px" width = "150px"></td>
	            			<td><?php echo $t2 ?></td>
	            			<td><a href="topSlider/edit_topSlider.php?editid=<?=$row['id']?>" class="btn btn-warning">Edit</a>  <a href="topSlider/topSlider.php?topSlider_id=<?=$row['id']?>" class="btn btn-danger" onclick = "return confirm('Are you sure want to delete')">Delete</a></td>
	            		</tr>
	            <?php	
	            $i++;
		        }
					    ...
					    <div class="modal-content">
	            			...
	            			?>
					     	<div class="modal-body">
					        	<div class="row">
					          		<div class="col-lg-6"><label for="">Category Name</label></div>
					          		<div class="col-lg-6"><input type="text" class="form-control hindi-input" name="up_cat_name" value="<?=$rr['cat_name']?>">
					          		</div>
					        	</div>
