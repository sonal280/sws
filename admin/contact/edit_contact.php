...
if (isset($_REQUEST['editid'])) {
  $select = "select * from address where cid = '".$_REQUEST['editid']."'";
              ...
              <form method="post" enctype="multipart/form-data" name="myForm" id="myForm">
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <div class="controls">
                     <textarea name="about" id="about" cols="30" rows="10" class="form-control hindi-input"><?=$row['about']?></textarea>
                  ...
                  <div class="form-group col-md-12">
                    ...
                    <div class="controls">
                    <input type="text" name="address" id="address" class="form-control hindi-input" value="<?=$row['address']?>">
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <div class="controls">
                      <input type="number" name="phone_number" id="phone_number" class="form-control" value="<?=$row['phone_number']?>"> 
                    </div>
                  </div>
                  <div class="form-group col-md-12">
                    <h5>Mobile Number<span class="text-danger">*</span></h5>
                    <div class="controls">
                      <input type="number" name="mobile_number" id="mobile_number"  class="form-control" value="<?=$row['mobile_number']?>"> 
                    </div>
                  </div>
                </div>
