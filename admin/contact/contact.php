...
if (isset($_REQUEST['cid'])) {
	$query = "DELETE FROM address WHERE cid = '".$_REQUEST['cid']."'";
	$result = mysqli_query($con, $query);
	if ($result) {
		echo "<script>alert('That Address is deleted');</script>";
	}
}
...
<div class="wrapper">
<a href="contact/new_contact.php" title="Add Category" id="return-to-top" class="btn btn-warning"><i class="fa fa-plus" ></i></a>
      ...
      <div class="box">
      	<div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive">
	        	...
	        	<tbody>
	            <?php 
	            	$select = "SELECT * FROM address order by cid desc";
				...
				<?php 
				 ...
				 ?>
	            		<tr>
	            			...
	            			<td><a href="contact/edit_contact.php?editid=<?=$row['cid']?>" class="btn btn-warning">Edit</a>  <a href="contact/contact.php?cid=<?=$row['cid']?>" class="btn btn-danger" onclick = "return confirm('Are you sure want to delete')">Delete</a></td>
	            		</tr>
	            <?php	
	            $i++;
		        }
