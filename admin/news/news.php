...
if (isset($_REQUEST['nid'])) {
	$query = "DELETE FROM news WHERE nid = '".$_REQUEST['nid']."'";
...
<div class="wrapper">
<a href="news/add_news.php" title="Add Category" id="return-to-top" class="btn btn-warning"><i class="fa fa-plus" ></i></a>
<?php include('../includes/header.php'); ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="news/add_news.php"><i class="fa fa-dashboard"></i> Home</a></li>
      	...
      	<div class="box-body">
              <table id="example1" class="table table-bordered table-striped table-responsive">
				...
				<?php 
					...
					$t2 = date('d-m-Y H:i A', strtotime($row['publish_date']));
				 ?>
	            		<tr>
	            			<td><?=$i;?></td>
	            			<td><?php echo $row['title']; ?></td>
	            			<td><img src="../admin/upload/news/<?php echo $row['image']; ?>" alt="" style ="height: 150px; width: 150px"></td>
	            			<td><?php echo $t2; ?></td>
	            			<td><a href="news/edit_news.php?editid=<?=$row['nid']?>" class="btn btn-warning">Edit</a> | <a href="news/news.php?nid=<?=$row['nid']?>" class="btn btn-danger" onclick = "return confirm('Are you sure want to delete')">Delete</a>
	            			</td>
	            		</tr>
	            <?php	
	            $i++;
