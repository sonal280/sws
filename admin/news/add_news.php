     ...
     <!-- Basic Forms -->
      <div class="box box-default">
        ...
        <div class="box-body">
          <div class="row">
            <div class="col">
              <form method="post" enctype="multipart/form-data" name="myForm" id="myForm" action="news/add_news_action.php">
                ...
                <div class="row">
                  <div class="form-group col-md-12">
                    ...
                    <div class="controls">
                      <input type="text" name="title" class="form-control hindi-input" data-validation-required-message="This field is required">
                     </div>
                  </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12"><label for=""><b>Description</b></label></div>
                      <div class="col-lg-12"><textarea required id="editor" cols="20" rows="10" class="form-control ckeditor hindi-input" name="description"></textarea>
                    </div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="form-group col-md-12">
                      ...
                      <div class="controls">
                        <input type="text" name="publish_date" id="publish_date" class="datepicker form-control" data-validation-required-message="This field is required"> </div>
                    </div>
                  </div>
