...
<html lang="en">
<head>
<title>Corporate Category Flat Bootstrap Responsive Website Template | Icons :: swslayouts</title>
<!-- Meta tag Keywords -->
...
<!-- icons -->
	<div class="sws_wthree_agileits_icons main-grid-border">
		<div class="container">
			<div class="sws-agileits-heading">
				<h3 class="title">Icons</h3> 
			</div>	
			<div class="grid_3 grid_4 sws_agileits_icons_page">
						<div class="icons">
