<?php 
	...
	if (!$exist) {
		$select = "INSERT INTO `advertisement`(`rid`, `add_title`, `addDescription`, `section`, `start_date`, `end_date`, `category`, `add_image`, `flag`) VALUES ('".$_SESSION['rid']."', '".$addTitle."', '".$addDescription."', '".$section."', '".$startDate."', '".$endDate."', '".$category."', '".$addImage."', 1)";
