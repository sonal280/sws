...
<html lang="en">
<head>
<title>Corporate Category Flat Bootstrap Responsive Website Template | Typography :: swslayouts</title>
<!-- Meta tag Keywords -->
...
<!-- typography -->
	<div class="typo">
		<div class="container">
			...
			<div class="grid_3 grid_4 swslayouts">
			...
			<div class="grid_3 grid_5 wthree">
				<h3>Badges</h3>
				<div class="col-md-6 agileits-swslayouts">
				...
				<div class="col-md-6 sws-agileits">
			...
			<div class="input-group sws_swslayouts">
			...
			<div class="input-group input-group-lg sws_swslayouts">
			...
			<div class="input-group input-group-sm sws_swslayouts">
